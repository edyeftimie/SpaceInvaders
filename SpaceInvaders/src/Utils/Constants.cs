...
namespace SpaceInvaders {
    public class Constants {
        ...
        public double playerTextureRatio { get; private set; } = 140 / 160.0;
        public int playerWidth {get; private set;} = 140;
        public int playerHeight {get; private set;} = 160;
        public int playerHealth {get;} = 10;
        public int playerDamage {get;} = 1;
        public double playerMovementSpeed {get;} = 10;
        public double enemyTextureRation { get; private set; } = 1.0;
        public int enemyWidth {get; private set;}
        public int enemyHeight {get; private set;} = 70;
        public int enemyHealth {get; private set;} = 1;
        public int enemyStartDamageInterval {get; private set;} = 1;
        public int enemyEndDamageInterval {get; private set;} = 1;
        public double enemyStartCooldownInterval {get; private set;} = 0.8;
        public double enemyEndCooldownInterval {get; private set;} = 3.5;
        ...
        public int spaceBetweenEnemies { get; private set; } = 100;
        public double weaponCooldown {get;} = 0.6;
        public int weaponAmmo {get;} = 1000;
        public double bulletTextureRation { get; private set; } = 1.0/2.0;
        public int bulletWidth { get; private set; }
        ...
        public Constants(int screenWidth, int screenHeight)
        {
            ...
            playerWidth = (int)((double)playerTextureRatio * (double)playerHeight);
            bulletWidth = (int)((double)bulletTextureRation * (double)bulletHeight);
            enemyWidth = (int)((double)enemyTextureRation * (double)enemyHeight);

            spaceBetweenBullets = (int)(enemyWidth/1.5);
